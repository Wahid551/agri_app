...
import 'package:agri_app/WSD_Machines/detail_page.dart';
...
class Machines_List extends StatefulWidget {
  const Machines_List({Key? key}) : super(key: key);

  @override
  _Machines_ListState createState() => _Machines_ListState();
}

class _Machines_ListState extends State<Machines_List> {
