import 'package:agri_app/WSD_Seeds/detail_page.dart';
...
class FertilizersList extends StatefulWidget {
  const FertilizersList({Key? key}) : super(key: key);

  @override
  _FertilizersListState createState() => _FertilizersListState();
}

class _FertilizersListState extends State<FertilizersList> {
  ...
  getFertilizers() {
    ...
    productProvider.getMyProductsList.where((element) {
      return element.category.contains("Fertilizers");
    }).toList();
    return products;
  }
  @override
