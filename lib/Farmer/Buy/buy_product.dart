import 'package:agri_app/Farmer/Buy/detail_page.dart';
...
class _BuyProductState extends State<BuyProduct> {
  ...
  getSeeds() {
    ...
    productProvider.getAllProductsList.where((element) {
      return element.category.contains("Seeds");
    }).toList();
    return products;
  }
  getFertilizers(){
  ...
  Widget build(BuildContext context) {
    ...
    productData=widget.category=="seeds"?getSeeds():widget.category=="fertilizers"?getFertilizers():getMachines();
