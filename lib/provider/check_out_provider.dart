...
class CheckoutProvider with ChangeNotifier {
  ...
  DeliveryAddressMode deliveryAddressList=DeliveryAddressMode(firstName: '', lastName:'', mobileNo:'', alternateMobileNo:'', society:'', street:'', landMark:'', city:'', area:'', pinCode:'', addressType:'');
